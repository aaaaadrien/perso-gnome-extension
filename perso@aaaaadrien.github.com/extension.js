...
function _get_radio()
{
	...
	switch (opt) {
		...
		case "net" :
			...
			break;
		case "publicip" :
			out = GLib.spawn_sync(null, ["bash","./.local/share/gnome-shell/extensions/perso@aaaaadrien.github.com/scripts/publicip.sh"], null, GLib.SpawnFlags.SEARCH_PATH,null,null,null,output);
			command_output_bytes = new String(out[1]);
			break;
	}
